  ...
  let utf8char: Gen<UTF8Char> =
    ...
    gen {
      ...
      | 2 ->
        ...
        return [|
          // MSB byte 1: 110xxxxx
          0b11000000uy ||| ((0b00000111uy &&& bs.[2]) <<< 2) ||| ((0b11000000uy &&& bs.[3]) >>> 6)
          // LSB byte 2: 10xxxxxx
          0b10000000uy ||| (0b00111111uy &&& bs.[3])
        |]
      ...
      | 3 ->
        ...
        return [|
          // byte 1: 1110 xxxx
          0b11100000uy ||| ((0b11110000uy &&& bs.[2]) >>> 4)
          // byte 2: 10 xxxx xx
          0b10000000uy ||| (((0b00001111uy &&& bs.[2]) <<< 2) ||| ((0b11000000uy &&& bs.[3]) >>> 6))
          // byte 3: 10 xx xxxx
          0b10000000uy ||| (0b00111111uy &&& bs.[3])
        |]
      ...
      | 4 ->
        ...
        return [|
          // byte 1: 11110xxx
          0b11110000uy ||| ((0b00011100uy &&& bs.[1]) >>> 2)
          // byte 2: 10xxxxxx
          0b10000000uy ||| ((0b11110000uy &&& bs.[2]) >>> 4) ||| ((0b00000011uy &&& bs.[1]) <<< 4)
          // byte 3: 10xxxxxx
          0b10000000uy ||| ((0b00001111uy &&& bs.[2]) <<< 2) ||| ((0b11000000uy &&& bs.[3]) >>> 6)
          // byte 4: 10xxxxxx
          0b10000000uy ||| (0b00111111uy &&& bs.[3])
