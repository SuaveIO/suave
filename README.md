...
We're using a cross-platform build suite called albacore/rake. Since the version of
the build is dynamically generated by, you need to generate the corresponding
AssemblyVersionInfo.fs files:
