...
Still in its early stages Suave suave supports HTTPS, multiple TCP/IP bindings, Keep-Alive. Suave also takes advantage of F# asynchronous workflows to perform non-blocking IO.
